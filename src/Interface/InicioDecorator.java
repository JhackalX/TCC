...
public class InicioDecorator {
    ...
    private JCheckBox jcbSalvarRelatorio;
    ...
    public void initComponets(){
        ...
        this.jcbSalvarRelatorio = new JCheckBox();
        ...
        this.btImportar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                try {
                    ...
                    Logger.getLogger(InicioDecorator.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void ConfigureFundoCamp(){
        ...
        this.jcbSalvarRelatorio.setText("Salvar relatorio em Read-me.txt");
            ...
            .addGroup(fundoLayout.createSequentialGroup()
                ...
                .addGroup(fundoLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(GroupLayout.Alignment.TRAILING, 
                        ...
                        .addComponent(this.jcbSalvarRelatorio)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 
                                         GroupLayout.DEFAULT_SIZE, 
                                          Short.MAX_VALUE)
